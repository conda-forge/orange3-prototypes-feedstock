...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/orange3-prototypes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13959&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/orange3-prototypes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `orange3-prototypes` can be installed with:

```
conda install orange3-prototypes
```

It is possible to list all of the versions of `orange3-prototypes` available on your platform with:
